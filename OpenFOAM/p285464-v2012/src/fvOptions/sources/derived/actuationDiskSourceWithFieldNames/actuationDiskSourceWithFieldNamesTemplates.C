...
void Foam::fv::actuationDiskSourceWithFieldNames::calc
(
...
template<class AlphaFieldType, class RhoFieldType>
void Foam::fv::actuationDiskSourceWithFieldNames::calcFroudeMethod
(
    const AlphaFieldType& alpha,
    const RhoFieldType& rho,
    fvMatrix<vector>& eqn
...
template<class AlphaFieldType, class RhoFieldType>
void Foam::fv::actuationDiskSourceWithFieldNames::calcVariableScalingMethod
(
    const AlphaFieldType& alpha,
    const RhoFieldType& rho,
    fvMatrix<vector>& eqn
