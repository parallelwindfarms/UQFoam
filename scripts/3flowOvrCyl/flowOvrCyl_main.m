function [ ] = flowOvrCyl_main(data, caseName, plotU_c, plotU_xByd, plotV_xByd, plotUU_xByd, plotVV_xByd, plotCd, plotCl, plotCp)
%% Make new dirs
...
legBool    = 'off';
leg_EXP_IPC = {'EXP 1','EXP 2','EXP 3','$\mu$','$\pm 2\sigma$'};
...
figure(1)
    ...
    leg1 = legend([plt1(1) plt1(2) plt1(3) plt2 fl1],leg_EXP_IPC,'Location','southeast');
    set(leg1,'Visible','on');
    set(leg1,'Color','none');
    hold off;
...
%     yticks([1 1.1 1.2 1.3 1.4 1.5]);
    ...
    leg1 = legend([plt1 fl1 plt2 fl2],{'$\mu_{C_d}$','$\pm 2\sigma_{C_d}$',...
           '$\mu_{<C_d>}$','$\pm 2\sigma_{<C_d>}$'},'Location','northeast');
    set(leg1,'Visible','on');
    hold off;
...
figure(7)
    ...
    leg1 = legend([plt1 fl1 plt2 fl2],{'$\mu_{C_l}$','$\pm 2\sigma_{C_l}$',...
           '$\mu_{<C_l>}$','$\pm 2\sigma_{<C_l>}$'},'Location','northeast');
    set(leg1,'Visible','on');
    hold off;
...
figure(8)
    ...
    leg1 = legend([plt1 plt2 fl1],{'EXP','$\mu$','$\pm 2\sigma$'}, 'Location','northeast');
    set(leg1,'Visible','on');
    hold off;
