...
casePngDir = '/2RRSTF/' + caseName+ '/png'
...
vtkFile = 'VTK_DET/' + caseName + '_0.vtk'
mesh, nCells, cCenter = myUQlib.getMeshInfo(cwd+vtkFile)

# <codecell> Importing k, R and creating the anisotropic tensor a_ij
RDet    = myUQlib.symmTensorToTensorv2012(mesh.cell_arrays['R'], nCells)
...
# R_symmTensor = np.loadtxt("postProcessing/sample/0/X_by_D_2_R.xy")[:,1:]
# for l in range(1,numLines):
#     fileName = 'postProcessing/sample/0/X_by_D_'+str(lines[l])+'_R.xy'
