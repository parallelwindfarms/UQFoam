function [ ] = turbChFlow_withDNS_withMC_withDET_main(data, caseName, ...
...
files = [   
            "nutMean0.xy";     
            "nutMeanSigma.xy"; "nutSigmaMean.xy";
            "pMeanSigma.xy";   "pSigmaMean.xy";
            "UMeanSigma_X.xy"; "USigmaMean_X.xy";
