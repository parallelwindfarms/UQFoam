...
# retained = False
# gSensIdx = myUQlib.getlogNFieldPCE(nutBl,stD,nCells,n,d,q,g,volAvg,retained,phyDim)
# TO DO IF NEEDED ---> get nutPCE modes and coefficients (like below)
