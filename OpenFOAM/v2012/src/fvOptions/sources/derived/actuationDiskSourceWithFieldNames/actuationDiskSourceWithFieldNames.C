...
#include "actuationDiskSourceWithFieldNames.H"
...
namespace fv
{
    defineTypeNameAndDebug(actuationDiskSourceWithFieldNames, 0);
    addToRunTimeSelectionTable(option, actuationDiskSourceWithFieldNames, dictionary);
}
}
...
const Foam::Enum
<
    Foam::fv::actuationDiskSourceWithFieldNames::forceMethodType
>
Foam::fv::actuationDiskSourceWithFieldNames::forceMethodTypeNames
({
...
const Foam::Enum
<
    Foam::fv::actuationDiskSourceWithFieldNames::monitorMethodType
>
Foam::fv::actuationDiskSourceWithFieldNames::monitorMethodTypeNames
({
...
void Foam::fv::actuationDiskSourceWithFieldNames::writeFileHeader(Ostream& os)
{
...
void Foam::fv::actuationDiskSourceWithFieldNames::setMonitorCells(const dictionary& dict)
{
...
Foam::fv::actuationDiskSourceWithFieldNames::actuationDiskSourceWithFieldNames
(
    const word& name,
    ...
    monitorCells_()
{
	...
	/******************************** Improvising **********************************/
    //fieldNames_.setSize(1, "U"); // Only 'U' allowed
    
    //fieldNames_.setSize(1, coeffs_.getOrDefault<word>("U", "U")); // Single field allowed
    
    coeffs_.readEntry("fields", fieldNames_); // Any number of fields allowed
...
void Foam::fv::actuationDiskSourceWithFieldNames::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
bool Foam::fv::actuationDiskSourceWithFieldNames::read(const dictionary& dict)
{
