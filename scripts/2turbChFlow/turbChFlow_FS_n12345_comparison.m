...
%     MagInset(figure(1), -1, [0.2 0.4 15 20], [0.5 0.95 2.5 15], {'NE','NE';'SW','SW'});
    ...
    leg1 = legend([plt1 plt(1) plt(2) plt(3) plt(4) plt(5)], allLeg ,'Location','southeast');
    set(leg1,'Visible','on');
    set(leg1,'Color','none');
...
%     MagInset(figure(2), -1, [0.2 0.4 15 20], [0.5 0.95 2.5 15], {'NE','NE';'SW','SW'});
    ...
    leg1 = legend([plt1 plt(1) plt(2) plt(3) plt(4) plt(5)], allLeg ,'Location','northeast');
